#!/usr/bin/env python
#
# This is a Puppet-managed copy of the example CGI script to export
# multiple hgweb repos normally found in:
# /usr/share/doc/mercurial-common/examples/hgwebdir.cgi
